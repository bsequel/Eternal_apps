    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=[
                    'folio_number', 'isin', 'entity_name', 'amc_name', 'scheme_name',
                    'transaction_date', 'transaction_description', 'value',
                    'stamp_duty', 'units', 'nav', 'unit_balance'
                ],
                name="unique_transaction_record"
            )
        ]
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=[
                    'folio_number', 'isin', 'entity_name', 'amc_name', 'scheme_name',
                    'closing_unit_balance', 'nav', 'total_cost_value', 'market_value', 'nav_date'
                ],
                name="unique_summary_record"
            )
        ]
